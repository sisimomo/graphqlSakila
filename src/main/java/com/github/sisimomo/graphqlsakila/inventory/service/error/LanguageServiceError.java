...
@AllArgsConstructor
@Getter
public enum LanguageServiceError implements Error {
  NOT_FOUND_BY_UUID(ErrorType.NOT_FOUND, "Language [UUID: %s] not found", "EQ8TOQ");
  ...
  LanguageServiceError(ErrorType errorType, String errorMessage, String errorId) {
