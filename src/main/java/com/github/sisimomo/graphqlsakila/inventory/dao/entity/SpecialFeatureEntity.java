...
/**
 * KEEP IN SYNC
 * {@link SpecialFeatureBatchLoaderProjection
 * Batch Loader Projection}.
 */
@Entity
@Table(name = "special_feature", uniqueConstraints = {@UniqueConstraint(columnNames = {BaseUuidEntity_.UUID})})
@NoArgsConstructor
@AllArgsConstructor
@Getter
@Setter
public class SpecialFeatureEntity extends BaseUuidAndLongAndLastUpdateEntity {
