...
@AllArgsConstructor
@Getter
public enum CountryServiceError implements Error {
  NOT_FOUND_BY_UUID(ErrorType.NOT_FOUND, "Country [UUID: %s] not found", "PXOR_G");
  ...
  CountryServiceError(ErrorType errorType, String errorMessage, String errorId) {
