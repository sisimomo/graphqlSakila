...
@Getter
@Setter
public abstract class BaseLongEntity implements IBaseLongEntity {

  /**
   * Create a column representing the id/primary key of the entity, which will be automatically
   * generated by the database when the entity is persisted for the first. This column cannot be null,
   * cannot be updated and cannot be inserted.
   */
  @Id
   ...
   * class, then return {@code false}. Otherwise, return {@code true} if the ids are equal.
   *
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    BaseLongEntity other = (BaseLongEntity) obj;
